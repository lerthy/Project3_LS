...
echo "  ✅ s3:GetBucketAcl / s3:PutBucketAcl"
echo "  ✅ s3:GetBucketTagging / s3:PutBucketTagging"
echo "  ✅ SNS:Subscribe and related actions"
echo "  ✅ Secrets Manager multi-region support"
echo "  ✅ IAM policy management permissions"
